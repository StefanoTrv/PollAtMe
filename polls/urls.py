...
urlpatterns = [
    ...
    path('vote/singlepreference/<int:id>/<str:token>', views.VoteSinglePreferenceView.as_view(), name = 'vote_single_preference_token'),
    path('vote/majorityjudgment/<int:id>/', views.VoteMajorityJudgmentView.as_view(), name = 'vote_MJ'),
    path('vote/majorityjudgment/<int:id>/<str:token>', views.VoteMajorityJudgmentView.as_view(), name = 'vote_MJ_token'),
    path('vote/shultze/<int:id>/', views.VoteShultzeView.as_view(), name = 'vote_shultze'),
    path('vote/shultze/<int:id>/<str:token>', views.VoteShultzeView.as_view(), name = 'vote_shultze_token'),
